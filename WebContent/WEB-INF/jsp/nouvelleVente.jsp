...
<div class="col-md-12" style="text-align: center;">
	<form method="post" name="form" id="form" action="./ServNouvelleVente"
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				<label for="Article">Article : </label> <input
					...
					placeholder="Entrez le nom de l'article" name="sArticle" required>
				<p></p>
			</div>
			<div class="form-group col-md-12">
				...
				<textarea style="width: 250px; display: block; margin: auto;"
					...
					placeholder="Entrez une description" name="sDescription" required></textarea>
				<p></p>
			</div>
		</div>
		...
		<div class="form-group">
			<label for="PrixInitial">Prix initial :</label> <input
				...
				class="form-control" id="prix" name="sPrix" min="0" required>
			<p></p>
		</div>
		<div class="form-row">
			<div class="form-group col-md-12">
				<label for="FinEnchere">Fin de l'enchère :</label> <input
					...
					class="form-control" id="date" min="2021-02-15" name="sDate"
					required>
				<p></p>
			</div>
			<div class="form-group col-md-12">
				<label for="inputState">Retrait</label> <input
					style="width: 350px; display: block; margin: auto;"
					class="form-control" id="retraitRue" value="${rue}" name="sAdresse"
					required placeholder="Entrez une adresse"> <input
					style="width: 150px; display: block; margin: auto;" type="text"
					class="form-control" id="retraitCp" value="${cp}" name="sCP"
					required placeholder="code postal"> <input
			...
			<div class="form-group col-md-12">
				<label class="form-label" for="customFile">Ajouter photo
					article :</label> <input style="width: 350px; display: block; margin: auto;" type="file" name="multiPartServlet"
					class="form-control" accept="image/*" multiple id="customFile"
					onchange="readFilesAndDisplayPreview(this.files);" /> <br /> <br />
				<br />
			</div>
